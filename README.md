...
|---|---|---|
| 🤖 AI Resume Analyzer | Python · Streamlit · OpenAI API | *Coming soon* |
| 📊 Power BI Sales Dashboard | Power BI · DAX · SQL | *Coming soon* |
| 🎫 IT Ticket Sentiment Analyzer | Python · scikit-learn · NLP · Streamlit | *Coming soon* |
